                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Satpam</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="editSecurityForm" action="{{ route('security.update') }}" method="post"  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="13" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" name="phone_number" id="phone_number" class="form-control" placeholder="Masukkan Nomor Telpon" value="{{ $security->phone_number }}">
                                                <span class="text-danger" id="phone_number_error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <select name="status" class="form-control" required>
                                                    <option value="1" {{ $security->status == '1' ? 'selected':'' }}>Aktif</option>
                                                    <option value="0" {{ $security->status == '0' ? 'selected':'' }}>Tidak Aktif</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" id="address" class="form-control" required value="{{ $security->address }}">
...
@section('js')
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#editSecurityForm').on('submit', function(event) {
