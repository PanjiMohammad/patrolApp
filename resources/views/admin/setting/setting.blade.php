                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="updateProfileForm" action="{{ route('user.postAccountSetting') }}" method="post">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control" required value="{{ $admin->email }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Masukkan Nomor Telepon" value="{{ $admin->phone_number }}">
                                                <span class="text-danger" id="phone_number_error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="address">Alamat</label>
                                                <input type="text" name="address" id="address" class="form-control" placeholder="Masukkan Alamat" value="{{ $admin->address }}">
